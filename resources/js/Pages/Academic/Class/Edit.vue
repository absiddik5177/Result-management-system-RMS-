              ...
              >
                ...
                <div class="item row">
                  ...
                  <Select
                    ...
                    label-text="Subject"
                    :form="form"
                    :options="groups[item.group_id]?.subjects"
                    trackBy="id"
                    label="name"
                    optional
  ...
  data() {
    return {
      form: useForm({
        ...
        short_name: this.form_data.short_name,
        has_group: Boolean(this.form_data.has_group),
        subjects: Object(this.form_data.subjects)
      }),
      mounted: reactive(true),
      loading: false,
    };
  },
  methods: {
    submit() {
      ...
      try{
        this.form.post(route('classes.update', this.form_data.id), {
          preserveScroll: true,
          onSuccess: () => {
            this.form.reset();
          },
